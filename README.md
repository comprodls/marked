...
The [Usage guide](https://github.com/comprodls/marked/blob/master/README.md#usage) provides the original usage of marked library. 
- For comproDLS extensions to the original library, please refer wiki page [comproDLS Extensions](https://github.com/comprodls/marked/wiki/01_comproDLS-Updates-to-Marked). 
